...
export default function Card({ pokiId }) {
  ...
  return (
    <div className="flex cursor-pointer flex-col items-center gap-4 rounded-lg border bg-[#444444] p-4 transition-transform duration-300 hover:scale-105 active:scale-95">
      <img
